      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8 lg:px-10">
        <div className="mb-12 space-y-4">
          ...
          <p className="text-lg text-slate-600 leading-8">
            These terms describe how Abdi Electronics operates, how owners list
        ...
        <section className="space-y-10">
          <article className="rounded-3xl bg-white p-10 shadow-sm border border-slate-200">
            ...
            <p className="text-slate-600 leading-7">
              Abdi Electronics provides an online marketplace for electronics
          ...
          <article className="rounded-3xl bg-white p-10 shadow-sm border border-slate-200">
            ...
            <p className="text-slate-600 leading-7">
              Owners must deliver products as described. Abdi Electronics
          ...
          <article className="rounded-3xl bg-white p-10 shadow-sm border border-slate-200">
            ...
            <p className="text-slate-600 leading-7">
              Abdi Electronics is not responsible for the content of third-party
